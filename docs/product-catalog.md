...
| 层级 | 含义 | 当前数量 |
|---|---|---:|
| P0 | 已完成详细公开字段核验的核心产品 | 12 |
| P1 | 下一批优先补齐详细字段的候选产品 | 6 |
...
| BitBrowser / 比特浏览器 | <https://www.bitbrowser.cn/> | 活跃 | 系统、内核、免费额度、价格、自动化、团队、存储 |
| Dolphin Anty | <https://dolphin-anty.com/> | 活跃 | 系统、内核、免费额度、价格、自动化、团队、存储 |
| GoLogin | <https://gologin.com/> | 活跃 | 系统、内核、免费额度、价格、自动化、团队、存储 |
| Hubstudio | <https://www.hubstudio.cn/> | 活跃 | 系统、内核、免费额度、价格、自动化、团队、存储 |
| ixBrowser | <https://www.ixbrowser.com/> | 活跃 | 系统、免费额度、价格、自动化、团队、存储；内核待确认 |
| MoreLogin | <https://www.morelogin.com/> | 活跃 | 系统、内核、免费额度、价格、自动化、团队、存储 |
| Multilogin | <https://multilogin.com/> | 活跃 | 系统、内核、免费额度、价格、自动化、团队、存储 |
| Octo Browser | <https://octobrowser.net/> | 活跃 | 系统、内核、试用条件、价格、自动化、团队、存储 |
| Roxy Browser | <https://roxybrowser.cn/> | 活跃 | 系统、内核、免费额度、价格、自动化、团队、存储 |
| VMLogin | <https://www.vmlogin.com.cn/> | 活跃 | 系统、内核、试用条件、价格、自动化、团队、存储 |
| Web4 Browser | <https://web4browser.io/cn/> | 活跃 | 系统、内核、免费额度、价格、自动化、团队、存储 |

这 12 款产品构成现有[`products.csv`](../data/products.csv)、[`pricing.csv`](../data/pricing.csv)和[详细对比](comparison.md)的核心。它们被列为 P0 不代表排名更高，只表示已经按统一字段完成首轮公开资料核验。Web4 Browser 与其他 11 款使用相同字段和证据规则。
...
P1 目前有 6 款。它们尚未进入 12 款核心表；后续只有在官方资料足以填写相同字段并完成冲突核对后，才会进入核心比较。留在 P1 不代表产品更差。
